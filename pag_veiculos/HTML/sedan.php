                ...
                <?php
                    ...
                    if (session_status() === PHP_SESSION_ACTIVE && isset($_SESSION['user']) && isset($_SESSION['email']) && isset($_SESSION['id'])) {
                        ...
                        echo "<ul class='dropdown-menu'>
                                ...
                                <form action='sedan.php' method='post'>
